...
export class SocialProfileHandler {
	register(composer: Composer<BotContext>): void {
		...
		composer.command("instagram", (ctx) => this.handlePrompt(ctx, "instagram_follow"));
		composer.command("xprofile", (ctx) => this.handlePrompt(ctx, "x_follow"));
		composer.command("twitter", (ctx) => this.handlePrompt(ctx, "x_follow"));
	}
