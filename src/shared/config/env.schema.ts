...
export const EnvSchema = z.object({
	...
	PRIMARY_DB: z.enum(["redis", "postgres"]).default("postgres"),
	...
	BROKER_ENABLED: BooleanFromStringSchema.default(false),
	...
	TELEGRAM_ALLOWLIST_IDS: z.string().default(""),
	TELEGRAM_ADMIN_IDS: z.string().default(""),
	FEATURES_ENABLED: z.string().default("template-status"),
	FEATURE_TEMPLATE_PING_ENABLED: BooleanFromStringSchema.default(true),
	FEATURE_TEMPLATE_ADMIN_STATUS_ENABLED: BooleanFromStringSchema.default(false),
