...
export class UserRepository {
	...
	private createDefaultQuestProgress(): QuestProgress {
        ...
        private normalizeUser(user: UserRecord): UserRecord {
                ...
                const questPoints: Partial<Record<QuestId, number>> = user.questPoints
                        ? { ...user.questPoints }
                        : {};
                if (!user.questPoints) {
                        changed = true;
                ...
                const referralBonusClaimed =
                        typeof user.referralBonusClaimed === "boolean" ? user.referralBonusClaimed : false;
